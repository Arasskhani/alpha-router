...
require_recommendations, require_recommendations_write = _menu_requires("recommendations")
...
require_monitoring = require_rbac_category("monitoring")
require_monitoring_write = require_rbac_category("monitoring", write=True)
