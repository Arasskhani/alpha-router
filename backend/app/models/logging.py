...
class RequestLog(Base):
    ...
    source = Column(String(32), default="gateway")  # openwebui | nitro_key | user_key
    client_app = Column(String(128), nullable=True)  # Kilo Code, Open WebUI, etc.
    nitro_api_key_id = Column(Integer, ForeignKey("nitro_api_keys.id", ondelete="SET NULL"), index=True, nullable=True)
