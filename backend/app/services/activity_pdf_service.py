...
def _render_activity_page_pdf_sync(
    *,
    ...
    init_script = f"""
localStorage.setItem("nitro_token", {token_json});
localStorage.setItem("nitro_role", {role_json});
localStorage.setItem("nitro_is_active", "1");
localStorage.setItem("nitro_login_at", String(Date.now()));
"""
