...
async def log_api_key_created(db: AsyncSession, *, key: AlphaRouterApiKey, actor: User, owner: User) -> None:
...
async def log_api_key_status(db: AsyncSession, *, key: AlphaRouterApiKey, actor: User, enabled: bool) -> None:
