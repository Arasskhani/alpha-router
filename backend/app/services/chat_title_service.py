...
_IMAGE_PREFIX = "__NITRO_IMAGE_JSON__:"
_IMAGE_PENDING = "__NITRO_IMAGE_PENDING__"
_INTERNAL_TITLE_PREFIXES = (
    _IMAGE_PREFIX,
    "__BILLI_IMAGE_JSON__:",
    "__NITRO_IMAGE__:",
    "__BILLI_IMAGE__:",
    "__NITRO_ATTACH_JSON__:",
    "__NITRO_AUDIO_JSON__:",
)
...
def _normalize_content_for_title(content: str) -> str:
    ...
    if t.startswith("__BILLI_IMAGE_JSON__:"):
        return _parse_json_prompt(t, "__BILLI_IMAGE_JSON__:", "Generated image")
    if t.startswith("__NITRO_IMAGE__:") or t.startswith("__BILLI_IMAGE__:"):
        return "Generated image"
    if t.startswith("__NITRO_ATTACH_JSON__:"):
        return _parse_json_prompt(t, "__NITRO_ATTACH_JSON__:", "")
    if t.startswith("__NITRO_AUDIO_JSON__:"):
        return _parse_json_prompt(t, "__NITRO_AUDIO_JSON__:", "")
    return t
