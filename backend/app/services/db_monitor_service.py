...
# NITRO application tables (read-only row counts for admins).
TABLE_LABELS: list[tuple[str, str]] = [
    ...
    ("ai_models", "Models"),
    ("nitro_api_keys", "Gateway API keys"),
    ("nitro_api_key_audit_logs", "API key change log"),
...
def _collect_system_metrics() -> dict[str, Any]:
    """Host and NITRO process CPU/RAM (machine or container running this API)."""
    out: dict[str, Any] = {
        "available": False,
        "host": None,
        "process": None,
