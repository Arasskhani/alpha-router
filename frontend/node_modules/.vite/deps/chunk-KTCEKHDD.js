...
var types = (
  /** @type {const} */
  {
    ...
    // Whole image (`![alpha-router](bravo)`, `![alpha-router][bravo]`, `![alpha-router][]`, or
    // `![alpha-router]`).
    ...
    labelEnd: "labelEnd",
    // Whole link (`[alpha-router](bravo)`, `[alpha-router][bravo]`, `[alpha-router][]`, or `[alpha-router]`).
    // Includes `label` and an optional `resource` or `reference`.
    link: "link",
    // Whole paragraph:
    //
...
//# sourceMappingURL=chunk-KTCEKHDD.js.map
