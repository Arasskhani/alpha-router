...
export declare class Area extends PureComponent<Props, State> {
    ...
    renderHorizontalRect(alpha_router: number): React.JSX.Element;
    renderVerticalRect(alpha_router: number): React.JSX.Element;
    renderClipRect(alpha_router: number): React.JSX.Element;
