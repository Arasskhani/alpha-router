...
function CodeBlockToolbar({
  ...
  return (
    <div
      className={`nitro-code-block__toolbar${position === "bottom" ? " nitro-code-block__toolbar--bottom" : ""}`}
    >
      {position === "top" ? <span className="nitro-code-block__lang">{langLabel}</span> : null}
      <div className="nitro-code-block__actions">
        <button
          type="button"
          className="nitro-code-block__action nitro-code-block__action--icon"
        ...
        <button type="button" className="nitro-code-block__action nitro-code-block__action--copy" onClick={() => void onCopy()}>
          {copied ? "Copied" : "Copy"}
        </button>
      </div>
    </div>
...
function ChatCodeBlockInner({ code, language, variant = "code", deferHighlight = false }: Props) {
  ...
  const codeClassName =
    lang === "python"
      ? `nitro-code-block__code language-python${highlightedHtml ? " hljs" : ""}`
      : "nitro-code-block__code nitro-code-block__code--plain";
  const label = languageLabel(lang, variant);

  return (
    <div
      className={`nitro-code-block${isOutput ? " nitro-code-block--output" : " nitro-code-block--python"}${expanded ? "" : " nitro-code-block--collapsed"}`}
      dir="ltr"
    >
      <CodeBlockToolbar
        expanded={expanded}
        ...
        onCopy={onCopy}
      />
      <pre className="nitro-code-block__pre" dir="ltr">
        {highlightedHtml ? (
          <code
