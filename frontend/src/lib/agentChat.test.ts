...
describe("formatAgentAnswerForDisplay", () => {
  it("replaces long cite markers with short isolated numbers", () => {
    ...
    const formatted = formatAgentAnswerForDisplay(
      "حساب Administrator را ایمن کنید [[cite:14e1fc73-da1e-5fa9-9662-f58c3e49e7ca]]. سپس Tiering [[cite:bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb]].",
      citations,
    );
