...
import { applyPolicyForm, policiesFromUnknown, readPolicyForm, splitExampleInput, splitKeywordInput, } from "./agentPolicyForm";
const seeded = {
...
describe("agentPolicyForm", () => {
    ...
    it("rejects a policy document that is not a map of objects", () => {
        expect(() => policiesFromUnknown({ routing_policy: ["vpn"] })).toThrow(/JSON object/);
    });
});
