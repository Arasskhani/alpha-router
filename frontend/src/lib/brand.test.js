...
import { ATTACHMENT_MESSAGE_PREFIX, AUDIO_MESSAGE_PREFIX, } from "./chatAttachments";
import { IMAGE_MESSAGE_PREFIX, IMAGE_PENDING_MARKER } from "./chatImage";
import { BROWSER_EVENT_NAMES, COOKIE_NAMES, PAGE_TITLE, PRODUCT_NAME, PRODUCT_NAME_MARKED, STORAGE_KEYS, TRADEMARK_OWNER, TRADEMARK_SYMBOL, } from "./brand";
import { CHAT_LEADER_LOCK_NAME, CHAT_REFRESH_EVENT_NAME, CHAT_SYNC_CHANNEL_NAME, } from "./chatLeader";
