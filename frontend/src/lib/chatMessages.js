...
export const CHAT_NO_MODELS_MESSAGE = "No models are currently available. Contact your administrator";
const LEGACY_NO_MODELS_PATTERNS = [
    "No enabled models",
    "Enable models in Admin",
];
export function chatModelsEmptyMessage() {
    return CHAT_NO_MODELS_MESSAGE;
}
/** Map older API/UI copy to the current user-facing message. */
export function normalizeChatModelsError(err) {
