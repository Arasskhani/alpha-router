 ...
 */
export function modelSupportsTextChat(m) {
    if (!m)
        return false;
...
export function isAutoRouterExternalId(externalId) {
 ...
 */
export function resolvePromptAssistModel(models, preferredId) {
 ...
 */
export function resolveDefaultModelPreference(models, saved) {
