...
import { modelSupportsSpeech, modelSupportsTextToSpeech, resolveSpeechGenerationModel, resolveSpeechVoiceForModel, } from "./chatSpeechModels";
import { buildSpeechRequestBody, shouldRouteToSpeechGeneration, } from "./chatSpeech";
...
describe("chatSpeech routing", () => {
    it("routes when tool and model support speech", () => {
        expect(shouldRouteToSpeechGeneration({
