...
import { filterCatalogModels, isNewlyListedModel, newWindowCounts, } from "./modelCatalog";
...
describe("isNewlyListedModel", () => {
    it("rejects models without a first-seen time", () => {
        ...
        expect(isNewlyListedModel(model({ id: 2, external_id: "b", first_seen_at: null }), 7, NOW)).toBe(false);
    });
