  ...
  return (
    ...
    <AdminPage title="Authentication">
      ...
      <p style={{ color: "var(--muted)" }}>
        ...
        Connect NITRO to your corporate directory. For Active Directory you only need the domain controller and a
        ...
        <form className="card" onSubmit={saveLdap}>
          ...
          <label className="input-block">
            ...
            <span className="muted-text" style={{ fontSize: "0.85rem" }}>
              ...
              NITRO will try LDAPS automatically when testing from Docker/Linux.
              ...
              onChange={async (e) => {
                ...
                if (next) {
                  const ok = await confirm({
                    ...
                    message:
                      "When enabled, users and groups outside the Sync OUs filter will be removed from Users and Groups on the next sync. Removed users cannot sign in. Users who have signed in to NITRO at least once will be moved to Deleted Users (their data stays on the server).",
