  ...
  return (
    ...
    >
      <p className="muted-text">
        Read-only monitoring for the NITRO PostgreSQL database and for CPU/RAM on the host (or container) running
        ...
        <>
          ...
          <div className="card db-monitor-resources">
            ...
            {data.system?.available && data.system.process && (
                <>
                  <h4 className="db-monitor-resource-heading">NITRO process</h4>
                  <dl className="db-monitor-dl">
                    <div>
                      <dt>PID</dt>
          ...
          <div className="card">
            <h3>Tables</h3>
            <p className="muted-text" style={{ marginTop: 0 }}>
              Row counts across NITRO tables (approx. {totalRows.toLocaleString()} rows total).
            </p>
