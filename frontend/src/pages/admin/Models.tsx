...
const VIEW_STORAGE_KEY = "nitro-models-view";
...
export default function Models() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("nitro-models-sync-flash", onSyncFlash);
    return () => window.removeEventListener("nitro-models-sync-flash", onSyncFlash);
  }, []);
