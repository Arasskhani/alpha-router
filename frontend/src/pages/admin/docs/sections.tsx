...
export const docSections: DocSection[] = [
    ...
    content: (
      <>
        ...
        <p className="docs-lead">
          NITRO is an organizational AI platform: a built-in web app for chat, media, and administration, plus an
  ...
  {
    id: "why-nitro",
    title: "Why NITRO exists",
    group: "Get started",
    content: (
      <>
        <h2>Why NITRO exists</h2>
        ...
        <ol>
          ...
          <li>
            ...
            automation) can share the same models and budgets when administrators issue NITRO API keys.
          </li>
        </ol>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <h2>Architecture</h2>
        <p>
          NITRO is one FastAPI app plus a React SPA. External tools use the OpenAI-compatible <code>/v1</code> surface;
        ...
        <ol>
          <li>
            Client calls <code>POST /v1/chat/completions</code> with <code>Authorization: Bearer &lt;NITRO key&gt;</code>{" "}
            and <code>stream: true</code> (non-streaming is rejected on this route).
          </li>
          <li>
            NITRO resolves the key (shared gateway key or per-user API key), provisions or maps the{" "}
          ...
          <li>
            ...
            latency are written to API logs (<code>source</code> e.g. gateway key, user key, nitro_chat).
          </li>
        </ol>
        <h3>Request path — NITRO Chat (<code>/api/chat</code>)</h3>
        <ol>
          <li>
          ...
          <li>
            The same <code>stream_chat</code> helper runs with <code>source=nitro_chat</code>; optional tools (web search,
        ...
        <ul>
          ...
          <li>
            Provider secrets never leave <strong>Connections</strong>; clients only ever see NITRO-issued keys or the web
            login session.
          </li>
        </ul>
        <Note>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          The NITRO Docker image contains only the application (FastAPI + built React UI). PostgreSQL, PgBouncer, and
        ...
        <table className="docs-table">
          ...
          <tbody>
            <tr>
              ...
              <td><code>…@pgbouncer:6432/nitro</code></td>
            ...
            <tr>
              ...
              <td>4</td>
              <td>Process count for the <code>nitro</code> container</td>
            </tr>
            <tr>
        ...
        <p>
          Compose wires Postgres, MinIO, and Redis automatically. Before exposing NITRO to real users, change at least:
        </p>
        <ul>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            and RAM, row counts per NITRO table. No SQL editor or schema changes.
          </li>
        </ul>
        <Note>
          Backups and managed Postgres consoles (RDS, etc.) remain outside NITRO. Use your infrastructure tooling for
    ...
    content: (
      <>
        ...
        <ol className="docs-steps">
          <li>
            <strong>Deploy NITRO</strong> with HTTPS in production. Copy <code>.env.example</code> to <code>.env</code> and
          ...
          <li>
            <strong>Integrate clients</strong> — Base URL <code>https://&lt;your-host&gt;/v1</code> + NITRO key (not the
  ...
  },
  {
    ...
    content: (
      <>
        <h2>Sign in</h2>
        <p>
          The login page summarizes what NITRO offers today — not only an API gateway, but a full organizational AI
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          If you open a URL outside your allowed menus, NITRO redirects you to your <strong>first allowed admin path</strong>{" "}
      ...
      <>
        ...
        <ul>
          ...
          <li>
            ...
            <code>nitro_private_chats:&lt;username&gt;</code>); image blobs and private image attachments live in{" "}
            <strong>IndexedDB</strong> (<code>nitro_private_media</code>). Image generation (text-to-image and
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>Controls sign-in to the NITRO web UI (not gateway API keys):</p>
        <ul>
          <li>
        ...
        <p>
          On Windows, NITRO uses signed LDAP when plain ldap3 bind fails (typical for AD). Store bind passwords in secure
          configuration only.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Note>
          Gateway keys are <em>not</em> provider keys. Never paste OpenRouter/OpenAI keys into clients when NITRO is your
          platform.
        </Note>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <h2>Roles (RBAC)</h2>
        <p>
          NITRO uses role-based access control (RBAC) for the admin panel. Open <strong>People &amp; access → Roles</strong>{" "}
        ...
        <Warn>
          Keep at least one active <strong>Super Admin</strong>. NITRO prevents demoting, disabling, or deleting the last
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            Blobs live in <strong>MinIO/S3</strong> (<code>S3_BUCKET</code>, default <code>nitro-media</code>). Keys:{" "}
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          The <strong>Monitoring</strong> sidebar group is for observing NITRO and traffic without changing configuration.
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            <strong>CPU</strong> — host vs NITRO process CPU %
          </li>
          <li>
            <strong>Memory</strong> — host RAM %; footer shows NITRO process RSS
          </li>
          <li>
        ...
        <p>
          NITRO reads <code>response_time_ms</code> from <code>request_logs</code> and sorts those values from fastest to
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            <strong>Host</strong> — CPU % and RAM used/total for the machine or Docker container running the NITRO API
            (via <code>psutil</code>)
          </li>
          <li>
            <strong>NITRO process</strong> — PID, process name, CPU %, and RSS memory for the current API worker
          </li>
        </ul>
        <p>
          These metrics are a snapshot when you click <strong>Refresh</strong>. They do not include separate Postgres or
          Redis containers unless those services run inside the same container as NITRO.
        </p>
        <h3>Tables panel</h3>
        <p>Row counts for NITRO tables, for example:</p>
        <ul>
          <li>
          ...
          <li>
            <code>media_assets</code>, <code>nitro_api_keys</code>, <code>user_api_keys</code>, <code>budget_plans</code>
          </li>
          <li>
  ...
  },
  {
    ...
    content: (
      <>
        <h2>Platform API</h2>
        <p>
          OpenAI-compatible HTTPS. Base path: <code>https://&lt;your-nitro-host&gt;/v1</code>. Use NITRO-issued keys
          only—never upstream provider keys in clients.
        </p>
        <Note>
          NITRO can act as an organizational <strong>AI gateway</strong> for OpenAI-compatible apps (for example{" "}
          <strong>Open WebUI</strong>): point the client&apos;s API base URL to <code>/v1</code> and paste a NITRO
          gateway or per-user key from <strong>API Keys</strong> or <strong>Users → Get API Key</strong>. Enable models
          in NITRO first; budgets and logs stay centralized.
        </Note>
        ...
        <h3>List models</h3>
        <Code>{`GET https://<your-nitro-host>/v1/models
Authorization: Bearer <NITRO_KEY>`}</Code>
        <h3>Chat completions (streaming required)</h3>
        <Code>{`POST https://<your-nitro-host>/v1/chat/completions
Authorization: Bearer <NITRO_KEY>
...
client = OpenAI(
    base_url="https://<your-nitro-host>/v1",
    api_key="<NITRO_KEY>",
)
...
client.chat.completions.create(
  ...
  },
  {
    ...
    content: (
      <>
        <h2 id="kilo-code">Kilo Code + NITRO</h2>
        <p>
          <a href="https://kilo.ai">Kilo Code</a> (VS Code extension) supports OpenAI-compatible providers. Use NITRO as
          that provider so IDE usage respects the same models and budgets as the rest of your organization.
        </p>

        <h3>Part A — Get a NITRO API key</h3>
        <ol className="docs-steps">
          <li>
            In NITRO, enable the models you need (<strong>Models</strong>).
          </li>
          <li>
          ...
          <li>
            Note the exact <strong>model id</strong> string from NITRO (Models table, <code>external_id</code> column)—you
        ...
        <ol className="docs-steps">
          ...
          <li>
            <strong>Base URL:</strong> NITRO URL, e.g. <code>https://nitro.company.com/v1</code>
          </li>
          <li>
            <strong>API Key:</strong> paste the NITRO key from the modal.
          </li>
          <li>
            <strong>Model:</strong> pick from auto-detected list (fetched from <code>/v1/models</code>) or enter the model
            id manually, e.g. <code>anthropic/claude-sonnet-4</code> (must match an enabled model in NITRO).
          </li>
          <li>
  ...
  "provider": {
    "openai-compatible": {
      "options": {
        "apiKey": "{env:NITRO_API_KEY}",
        "baseURL": "https://<your-nitro-host>/v1"
      }
    }
  },
  "model": "openai-compatible/<enabled-model-id>"
        ...
        <ul>
          <li>
            <strong>Model not found</strong> — Model must be enabled in NITRO and id must match exactly (case-sensitive).
          </li>
          <li>
          ...
          <li>
            <strong>Budget exceeded</strong> — Check the user&apos;s <strong>Budget</strong> in NITRO; per-user keys use
            that user&apos;s pool.
          </li>
          <li>
            <strong>Azure GPT-5 / special providers</strong> — Use native provider support in Kilo when required; generic
            OpenAI-compatible mode targets NITRO&apos;s OpenAI-style <code>/v1/chat/completions</code>.
          </li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>NITRO does not markup provider prices.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>Rotate provider and NITRO keys regularly; disable unused keys.</li>
          ...
          <li>
            Back up PostgreSQL and the MinIO/S3 media bucket outside NITRO; use{" "}
  ...
  },
  {
    ...
    content: (
      <>
        <h2>Copyright</h2>
        <p>
          NITRO was designed by <strong>Majid Arasskhani</strong> and developed by <strong>Cursor AI</strong> within
