...
export const userManualSections: DocSection[] = [
    ...
    content: (
      <>
        ...
        <p className="docs-lead">
          This guide explains how to use NITRO as an end user: chat with enabled AI models, manage your media files,
        ...
        <div className="docs-cards">
          ...
          <div className="docs-card">
            ...
            <p>Personalized model suggestions based on how you use NITRO — quality fit and value picks for your workload.</p>
          </div>
          <div className="docs-card">
    ...
    content: (
      <>
        ...
        <p>
          ...
          keys or uncontrolled spend. NITRO is that platform: your company runs it, assigns you a budget, and exposes
          only approved models through a built-in web app (and optionally an OpenAI-compatible <code>/v1</code> API).
        </p>
        <p>As a user, NITRO gives you:</p>
        <ul>
          <li>
        ...
        <Note>
          NITRO can also expose an optional organizational AI gateway (<code>/v1</code>) for external tools (for example
  ...
  {
    id: "nitro-documentation",
    title: "NITRO documentation",
    group: "Get started",
    content: (
      <>
        <h2>NITRO documentation</h2>
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>
            <strong>Multiple tabs</strong> — if you open NITRO in several tabs, they stay in sync via lightweight refresh.
        ...
        <table className="docs-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                When your message contains URLs, NITRO can fetch and read those pages so the model can summarize or
            ...
            <tr>
              ...
              <td>
                ...
                the NITRO server. Chat metadata is stored in <strong>localStorage</strong>; images and image attachments
        ...
        <Note>
          ...
          <strong>not</strong> part of NITRO — context is limited to the messages in the current chat thread.
        </Note>
        ...
        <ul>
          ...
          <li>
            ...
            streaming in the browser stops (this is normal). Sign in again and open the same chat; NITRO polls the server
        ...
        <Warn>
          NITRO can make mistakes. Verify important facts before acting on model output.
        </Warn>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <h3>Web Fetch</h3>
        <p>
          <em>Read links in your message.</em> Include one or more URLs in your prompt; NITRO fetches page content so the
        ...
        <p>
          ...
          you press Send. Works for text chat and image prompts alike. NITRO keeps your original wording when the model
        ...
        <ol>
          ...
          <li>
            The model may reply with a <code>```python</code> fenced block. NITRO runs the <strong>last</strong> Python
        ...
        <ul>
          ...
          <li>
            Code runs on the NITRO server, not in your browser. Do not paste secrets into prompts when this tool is on.
          </li>
        </ul>
        <Note>
        ...
        <h3>Private Mode</h3>
        <p>
          <em>Store this chat and its media on this device only.</em> Nothing from this session is written to the NITRO
          server while Private Mode is on: no server sync, no Media library entries, no access from other browsers.
          Confirm when enabling (the dialog appears in front of the Tools menu). To disable, NITRO tries to upload local
        ...
        <ul>
          ...
          <li>
            ...
            <strong>IndexedDB</strong> (<code>nitro_private_media</code>); message JSON holds small references only.
          </li>
          <li>
    ...
    content: (
      <>
        ...
        <p>
          ...
          <strong>Private Mode</strong> on this device only). Files are stored on the organization&apos;s NITRO server
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Open <strong>Recommendations</strong> from the sidebar (<code>/app/recommendations</code>). NITRO analyzes your
