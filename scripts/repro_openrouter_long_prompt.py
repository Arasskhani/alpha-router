...
LONG_PROMPT = (
    ...
    "metal, frosted glass, iridescent puddles reflecting neon signs reading OPEN, NITRO, and stylized arrows. "
...
async def _post(api_key: str, base_url: str, payload: dict) -> tuple[Any, dict | None]:
    ...
    headers = build_openrouter_headers(api_key, referer="https://nitro.local")
